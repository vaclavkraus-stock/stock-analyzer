    ...
    try{
      const res = await fetch("/api/analyze", {
        ...
        body:JSON.stringify({
          ...
          messages:[{role:"user",content:`Search the web for "${t}" stock on ${exchInfo.label} (${exchInfo.hint}) and return data in LOCAL CURRENCY: ${exchInfo.currency}. CRITICAL: All prices, targets, intrinsic values must be in ${exchInfo.currency} - do NOT convert to USD. Do 3 searches: 1) "${t} ${exchInfo.hint} stock price ${exchInfo.currency} 2025 2026" 2) "${t} analyst price target ${exchInfo.currency} earnings 2026" 3) "${t} stock news 2026 site:reuters.com OR site:bloomberg.com OR site:cnbc.com OR site:finance.yahoo.com". Return ONLY raw JSON. Today is March 2026. The "currency" field MUST be "${exchInfo.currency}". Every numeric field must have a real non-zero value. IMPORTANT: For each news item provide the full direct URL to the specific article from search results.
...
{"name":"","ticker":"${t}","exchange":"${exchInfo.hint}","sector":"","currency":"${exchInfo.currency}","description":"2 věty česky","price":{"current":0,"changePct":0,"marketCap":"","w52High":0,"w52Low":0,"volume":""},"metrics":{"pe":0,"eps":0,"netMargin":0,"grossMargin":0,"roe":0,"beta":0,"dividendYield":0,"debtEquity":0,"freeCashFlowB":0,"revenueGrowthPct":0},"radarScores":{"valuation":5,"growth":5,"profitability":5,"financialHealth":5,"momentum":5,"dividend":5},"annuals":[{"year":"2022","revB":0,"niB":0,"eps":0},{"year":"2023","revB":0,"niB":0,"eps":0},{"year":"2024","revB":0,"niB":0,"eps":0},{"year":"2025","revB":0,"niB":0,"eps":0}],"quarters":[{"q":"Q3 2025","revB":0,"niB":0,"eps":0,"yoy":0},{"q":"Q4 2025","revB":0,"niB":0,"eps":0,"yoy":0},{"q":"Q1 2026","revB":0,"niB":0,"eps":0,"yoy":0}],"peHistory":[{"year":"2022","pe":0},{"year":"2023","pe":0},{"year":"2024","pe":0},{"year":"2025","pe":0}],"history":[{"date":"Kvě '24","price":0,"sp500":0},{"date":"Srp '24","price":0,"sp500":0},{"date":"Lis '24","price":0,"sp500":0},{"date":"Úno '25","price":0,"sp500":0},{"date":"Čer '25","price":0,"sp500":0},{"date":"Bře '26","price":0,"sp500":0}],"analysts":{"buy":0,"hold":0,"sell":0,"avgTarget":0,"lowTarget":0,"highTarget":0},"dcf":{"intrinsicValue":0,"upside":0,"wacc":0},"technicals":{"ma50":0,"ma200":0,"rsi":0,"support":0,"resistance":0},"earningsCalendar":{"nextDate":"","quarter":"","estimatedEPS":0,"estimatedRevB":0,"lastSurprisePct":0},"earningsHistory":[{"quarter":"Q4 2025","date":"","estimatedEPS":0,"actualEPS":0,"estimatedRevB":0,"actualRevB":0},{"quarter":"Q3 2025","date":"","estimatedEPS":0,"actualEPS":0,"estimatedRevB":0,"actualRevB":0},{"quarter":"Q2 2025","date":"","estimatedEPS":0,"actualEPS":0,"estimatedRevB":0,"actualRevB":0},{"quarter":"Q1 2025","date":"","estimatedEPS":0,"actualEPS":0,"estimatedRevB":0,"actualRevB":0}],"buffettChecklist":[{"criterion":"ROE > 15%","passed":true,"note":""},{"criterion":"Nízký dluh","passed":true,"note":""},{"criterion":"Růst zisku","passed":true,"note":""},{"criterion":"Silný FCF","passed":true,"note":""},{"criterion":"Ekonomický příkop","passed":true,"note":""},{"criterion":"Srozumitelné podnikání","passed":true,"note":""},{"criterion":"Management vlastní akcie","passed":false,"note":""},{"criterion":"P/E pod průměrem","passed":false,"note":""}],"insiders":[{"name":"","role":"","type":"buy","shares":0,"valueM":0,"date":""}],"competitors":[{"ticker":"","name":"","pe":0,"revGrowthPct":0,"netMarginPct":0,"marketCapB":0},{"ticker":"","name":"","pe":0,"revGrowthPct":0,"netMarginPct":0,"marketCapB":0}],"macro":{"fedRate":0,"inflation":0,"sectorYtdPct":0,"sp500YtdPct":0,"outlook":"","sectorFearGreed":50,"sectorFearGreedLabel":"Sentiment sektoru neutrální","sectorTopStocks":["","",""]},"news":[{"title":"","summary":"česky","sentiment":"positive","date":"","source":"","url":"https://"},{"title":"","summary":"česky","sentiment":"negative","date":"","source":"","url":"https://"},{"title":"","summary":"česky","sentiment":"neutral","date":"","source":"","url":"https://"},{"title":"","summary":"česky","sentiment":"positive","date":"","source":"","url":"https://"},{"title":"","summary":"česky","sentiment":"neutral","date":"","source":"","url":"https://"}],"risks":["","",""],"catalysts":["",""],"verdict":"KOUPIT","score":7,"targetPrice":0,"investmentThesis":"5 vět česky","pros":["",""],"cons":["",""]}`}]
  ...
  if(!loading&&!data) return (
    <div style={{minHeight:"100vh",background:`radial-gradient(ellipse at 20% 50%, #0d1f3c 0%, ${C.bg} 60%)`,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"system-ui,sans-serif",padding:24}}>
      ...
      <div style={{position:"fixed",top:16,right:20,zIndex:100}}><UserButton afterSignOutUrl="/"/></div>
  ...
  if(loading) return (
    <div style={{minHeight:"100vh",background:C.bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"system-ui,sans-serif"}}>
      ...
      <p style={{color:C.muted,fontSize:13,marginBottom:28}}>Vyhledávám data, čekej ~30 sekund</p>
      <div style={{width:240,height:3,background:C.border,borderRadius:4,overflow:"hidden"}}>
    ...
    <div style={{minHeight:"100vh",background:C.bg,fontFamily:"system-ui,sans-serif",color:C.text}}>
      ...
      <div style={{maxWidth:1400,margin:"0 auto",padding:isMobile?"12px 10px 50px":"18px 24px 50px",display:"flex",flexDirection:"column",gap:12}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:12}}>
          ...
          <Card>
            <SectionTitle icon="📉" title="Historické P/E Ratio" sub="Valuace v čase"/>
            <ResponsiveContainer width="100%" height={185}>
          ...
          <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:8}}>
            {bc.map((b,i)=>(
              <div key={i} style={{background:b.passed?C.green+"10":C.red+"08",border:`1px solid ${b.passed?C.green+"30":C.red+"20"}`,borderRadius:11,padding:"10px 14px",display:"flex",gap:10,alignItems:"flex-start"}}>
                ...
                <div><div style={{fontWeight:700,fontSize:12,marginBottom:2}}>{b.criterion}</div><div style={{color:"#94a3b8",fontSize:11,lineHeight:1.5}}>{b.note}</div></div>
              </div>
            ))}
          </div>
        </Card>
        ...
        <Card>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14,flexWrap:"wrap",gap:8}}>
            <SectionTitle icon="📅" title="Roční Výsledky" sub={`v miliardách ${ccy}`}/>
            <div style={{display:"flex",gap:4}}>
        ...
        <Card>
          ...
          <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:16,alignItems:"start"}}>
            ...
            <table style={{width:"100%",borderCollapse:"collapse",fontSize:12}}>
              <thead><tr>{["Kvartál","Rev (B)","Zisk (B)","EPS","YoY"].map(h=><th key={h} style={{textAlign:"left",padding:"5px 8px",color:C.muted,fontSize:9,textTransform:"uppercase",fontWeight:600,borderBottom:`1px solid ${C.border}`}}>{h}</th>)}</tr></thead>
              <tbody>{quarters.map((q,i)=>(
                <tr key={i} style={{borderBottom:`1px solid ${C.border}20`}}>
                  <td style={{padding:"7px 8px",fontWeight:700,fontSize:11}}>{q.q}</td>
                  <td style={{padding:"7px 8px",color:"#94a3b8"}}>{fmt(q.revB)}</td>
                  <td style={{padding:"7px 8px",color:"#94a3b8"}}>{fmt(q.niB)}</td>
                  <td style={{padding:"7px 8px",fontWeight:600}}>{fmt(q.eps)}</td>
        ...
        <Card>
          <SectionTitle icon="🏁" title="Srovnání s Konkurencí"/>
          <table style={{width:"100%",borderCollapse:"collapse",fontSize:13}}>
            <thead><tr>{["Ticker","Firma","Market Cap","P/E","Rev. Růst","Net Marže"].map(h=><th key={h} style={{textAlign:"left",padding:"6px 10px",color:C.muted,fontSize:10,textTransform:"uppercase",fontWeight:600,borderBottom:`1px solid ${C.border}`}}>{h}</th>)}</tr></thead>
            <tbody>
              <tr style={{background:C.blue+"12",borderBottom:`1px solid ${C.border}30`}}>
                ...
                <td style={{padding:"8px 10px",color:"#94a3b8"}}>{pr.marketCap}</td>
              ...
              {competitors.filter(c=>c.ticker).map((c,i)=>(
                <tr key={i} style={{borderBottom:`1px solid ${C.border}15`}}>
                  ...
                  <td style={{padding:"8px 10px",color:"#94a3b8"}}>{c.name}</td>
                  <td style={{padding:"8px 10px",color:"#94a3b8"}}>{fmt(c.marketCapB)}B</td>
            ...
            <table style={{width:"100%",borderCollapse:"collapse",fontSize:13}}>
              ...
              <tbody>{insiders.filter(ins=>ins.name).map((ins,i)=>(
                <tr key={i} style={{borderBottom:`1px solid ${C.border}15`}}>
                  ...
                  <td style={{padding:"8px 10px",color:"#94a3b8"}}>{ins.shares?.toLocaleString?.()}</td>
                  <td style={{padding:"8px 10px",color:"#94a3b8"}}>{ccy} {fmt(ins.valueM)}M</td>
        ...
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:12}}>
          ...
          <Card>
            <h3 style={{margin:"0 0 12px",fontSize:14,fontWeight:800,color:C.green}}>🚀 Katalyzátory</h3>
            {catalysts.filter(c=>c).map((c,i)=><div key={i} style={{display:"flex",gap:8,marginBottom:7}}><span style={{color:C.green,fontSize:8,marginTop:5,flexShrink:0}}>●</span><span style={{color:"#94a3b8",fontSize:12,lineHeight:1.5}}>{c}</span></div>)}
          </Card>
        </div>
